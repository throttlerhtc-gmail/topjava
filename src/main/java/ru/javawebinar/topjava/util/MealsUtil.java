...
public class MealsUtil {
    ...
    public static MealTo getTo(Collection<Meal> meals, int caloriesPerDay, int id) {
        return getTos(meals, caloriesPerDay).stream().filter(meal -> meal.getId() == id).findAny().orElse(null);
    }
